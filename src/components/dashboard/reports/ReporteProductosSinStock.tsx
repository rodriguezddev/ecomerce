...
interface ReporteProductosSinStockProps {
  empresa: string;
  año: string;
}

const ReporteProductosSinStock: React.FC<ReporteProductosSinStockProps> = ({
  ...
  // Obtener productos con stock cero (los primeros 10)
  const productosSinStock: ProductoSinStock[] = products
    ...
    <div style={{ width: '100%', fontFamily: 'Arial, sans-serif' }}>
      <div className="report-container" style={{
        ...
        <div className="content" style={{ padding: '8px' }}>
          <h2 style={{ fontSize: '12px', margin: '0 0 6px 0', textAlign: 'center' }}>Productos Sin Existencia</h2>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '8px', fontSize: '8px' }}>
              ...
              <tbody>
                {productosSinStock.length === 0 ? (
                  <tr>
                    <td colSpan={3} style={{ border: '1px solid transparent', padding: '2px 3px', textAlign: 'center' }}>
...
export default ReporteProductosSinStock;